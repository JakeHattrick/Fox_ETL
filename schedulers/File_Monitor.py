...
DUMMY_TSG_FILENAME = "FXNC_PB-DEBUG_692-2G506-0200-0R6_1320222088828_P_BAT_20250908T133950Z.tsg"
...
IMPORT_DUMMY_SCRIPT = os.path.join(ETL_V2_DIR, "loaders", "import_dummy_file.py")
